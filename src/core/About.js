                    ...
                    <div className="border rounded shadow">
                        <div className="card m-2 ">
                            ...
                            <a href="#" className='p-3 font-weight-bold text-warning'><i class="fa fa-clock-o" aria-hidden="true"></i> ---2022---</a>
                                <p className="text-justify p-3">TravelYaari website is created by Paritosh Soni, Satyam Gupta , Mohit Devade and Ritik Jain (Students at SVVV university),credited with developing the predecessor to online website. The motivation behind is Most travel websites charges international charges for certain booking when opting internationally, but we aim to provide booking free of any international charges across the globe without a single penny. We also aim to have branches in many countries and we shall provide facility of user interest as per their needs. We aim to deal with the best hotels , motels and lauge, so we provide quality services to our costumers.
                                <br />
                                <a href="#" className='font-weight-bold text-info'><i class="fa fa-clock-o" aria-hidden="true"></i> --- December 2022---</a><br />
                                In the december 2022, TravelYaari website get Deployed to various platform including github pages and heroku <br />
                              
                                <a href="#" className='font-weight-bold text-success'><i class="fa fa-clock-o" aria-hidden="true"></i> --- April 2022---</a><br />
                                In the April 2022, TravelYaari website get itself developed by MERN Stack & Deployed to various platform. 
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card m-2 ">
                            ...
                            <div class="card-body m-0 p-0">
                                <ul className="list-group">
                                    <li className="list-group-item text-info h6 font-weight-bold">Paritosh Soni</li>
                                    <li className="list-group-item text-info h6 font-weight-bold">Satyam Gupta</li>
                                    <li className="list-group-item text-info h6 font-weight-bold">Mohit Devade</li>
                                    <li className="list-group-item text-info h6 font-weight-bold">Ritik Jain</li>
