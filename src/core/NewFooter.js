...
import logo from "../image/luklogo.png";
    ...
    <Container fluid style={{ padding: "0", paddingTop: "5rem",overflow:"auto" }}>
        ...
        <section style={{padding:'1rem'}}>
          <Row>
            <Col sm={6} md={3}>
              ...
              <ListGroup>
                <Ul>
                  A Solution that activates the travelling bug with vibrant
                  imagery and working on to continuously provides enjoyable
                  quality excursions/trips on time and on budget.We Focus on
                  developing enthusiastically satisfied customers all of the
                  time.
                </Ul>
              </ListGroup>
            </Col>
      ...
      <DevInfo>
        <div>
          ...
          >
            © {new Date().getFullYear()} , Lukjury Travel . All rights are reserved
