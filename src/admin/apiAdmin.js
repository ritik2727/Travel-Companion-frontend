...
export const createCoupon = (userId, token, coupon) => {
  return fetch(`${API}/user/couponcreate/${userId}`, {
    method: "POST",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
...
export const listCoupon = (userId, token) => {
  return fetch(`${API}/couponlist/${userId}`, {
    method: "GET",
    headers: {
      Accept: "application/json",
      Authorization: `Bearer ${token}`,
...
export const deleteCoupon = (couponId, userId, token) => {
  return fetch(`${API}/coupondelete/${couponId}/${userId}`, {
    method: "DELETE",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
